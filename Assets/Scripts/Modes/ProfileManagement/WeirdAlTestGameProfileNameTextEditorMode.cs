...
namespace PinballClub.WeirdAlTestGame.Modes.Menu {
	...
	public class WeirdAlTestGameProfileNameTextEditorMode : SelectorMode {
	
		public WeirdAlTestGameProfileNameTextEditorMode(P3Controller controller, int priority)
