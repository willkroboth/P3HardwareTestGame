...
namespace PinballClub.WeirdAlTestGame.Modes
{
	...
	/// </summary>
	public static class WeirdAlTestGamePriorities
	{
        ...
        public const int PRIORITY_EVENT_NAME_EDITOR = WeirdAlTestGamePriorities.PRIORITY_TEXT_EDITOR + 1;
		public const int PRIORITY_HIGH_SCORE_NAME_SELECTOR = WeirdAlTestGamePriorities.PRIORITY_TEXT_EDITOR + 2;
