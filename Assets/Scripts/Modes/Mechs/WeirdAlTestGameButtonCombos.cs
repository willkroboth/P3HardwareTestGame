...
namespace PinballClub.WeirdAlTestGame.Modes
{
    ...
    public class WeirdAlTestGameButtonCombosMode : P3Mode
	{
		...
		public WeirdAlTestGameButtonCombosMode (P3Controller controller, int priority)
			: base(controller, priority)
		{
			Multimorphic.P3App.Logging.Logger.Log ("WeirdAlTestGameButtonCombosMode initialized");
