...
namespace PinballClub.WeirdAlTestGame.Modes.Menu
{
    ...
    public class WeirdAlTestGameConfirmationBoxMode : ConfirmationBoxMode
	{
		Dictionary<string, string> legend;
		protected bool buttonAlreadyActive;
		protected bool active;

		public WeirdAlTestGameConfirmationBoxMode (P3Controller controller, int priority)
		...
		protected override void End()
		{
			base.End();
			active = false;
			Multimorphic.P3App.Logging.Logger.Log ("WeirdAlTestGameConfirmationBoxMode: End - Hiding button legend.");
