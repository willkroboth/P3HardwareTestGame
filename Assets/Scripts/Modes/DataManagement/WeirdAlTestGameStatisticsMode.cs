...
{
	public class WeirdAlTestGameStatisticsMode : StatisticsMode
	{
		public WeirdAlTestGameStatisticsMode (P3Controller controller, int priority)
			: base(controller, priority)
		{
			Setup ();
		}

		public WeirdAlTestGameStatisticsMode (P3Controller controller, int priority, string eventName, string eventDir)
