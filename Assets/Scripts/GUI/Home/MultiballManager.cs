	...
	public class MultiballManager : P3Aware {
		...
		public override void Update () {
			...
			if (multiballCalloutTimer > 0) {
				...
				if (multiballCalloutTimer <= 0) {
					WeirdAlTestGameAudio.Instance.PlaySound3D(multiballCalloutName, gameObject.transform);
				}
			}
		}
		...
		public void superDuperJackpotLitEventHandler(string eventName, object eventObject) {
			...
			if (on) {
				...
				WeirdAlTestGameAudio.Instance.PlaySound3D("SuperDuperJackpotLit", gameObject.transform);
			}
			else
		...
		public void MultiballStartEventHandler(string eventName, object eventObject) {
            ...
            // WeirdAlTestGameAudio.Instance.RefillSoundGroupPool("SaucerEject_Fire");
		...
		public void MultiballNoLockEventHandler(string eventName, object eventObject) {
			WeirdAlTestGameAudio.Instance.PlaySound3D("Saucer_Ball_NoLock", gameObject.transform);
		}

		public void MultiballLockEventHandler(string eventName, object eventObject) {
			WeirdAlTestGameAudio.Instance.PlaySound3D("Saucer_Ball_Lock", gameObject.transform);
		...
		public void MultiballEjectEventHandler(string eventName, object eventObject) {
			WeirdAlTestGameAudio.Instance.PlaySound3D("SaucerEject_Fire", gameObject.transform);
		}

		public void MultiballLockLitEventHandler(string eventName, object eventObject) {
			WeirdAlTestGameAudio.Instance.PlaySound3D("LockIsLit", gameObject.transform);
