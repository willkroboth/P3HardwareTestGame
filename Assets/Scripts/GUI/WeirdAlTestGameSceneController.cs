...
namespace PinballClub.WeirdAlTestGame.GUI {
	public class WeirdAlTestGameSceneController : SceneController {
		
		const string APP_CODE = "WeirdAlTestGame";
        ...
        public override void Start() {
            ...
            IntroActive = false;
            noCreditCount = 0;
            if (WeirdAlTestGameAudio.Instance != null)
            {
                WeirdAlTestGameAudio.Instance.StopAllPlaylists();
                WeirdAlTestGameAudio.Instance.ChangePlaylistByName("BG_Mode_Introduction");
            }
		}
		...
		protected virtual void EndIntro() {
            ...
            if (WeirdAlTestGameAudio.Instance != null)
			    WeirdAlTestGameAudio.Instance.ChangePlaylistByName(sceneName);
		}
		...
		public void ScoringXEventHandler(string eventName, object eventObject) {
			WeirdAlTestGameAudio.Instance.PlaySound3D("2X_Scoring", gameObject.transform);
			//WeirdAlTestGameAudio.Instance.ChangePlaylistByName("Multiball");
		...
		public void CreditAddedEventHandler(string eventName, object eventObject) {
			WeirdAlTestGameAudio.Instance.PlaySound3D("Credits_New_Credit", gameObject.transform);
		}

		public void CoinAddedEventHandler(string eventName, object eventObject) {
			WeirdAlTestGameAudio.Instance.PlaySound3D("AddMoneyPartialCredit", gameObject.transform);
		}

		public void NoCreditEventHandler(string eventName, object eventObject) {
			if (noCreditCount < 3) {
				WeirdAlTestGameAudio.Instance.PlaySound3D("Credits_No_Credit", gameObject.transform);
				noCreditCount++;
			}
		}

		public void BallLaunchedEventHandler(string eventName, object eventObject) {
			WeirdAlTestGameAudio.Instance.PlaySound3D("Ball_Launch", gameObject.transform);
		}
		...
		public void ShowPlayerAddedEventHandler(string eventName, object eventObject) {
			...
			WeirdAlTestGameAudio.Instance.PlaySound3D("PlayerAdded", gameObject.transform);
		...
		public void ShowPlayerRemovedEventHandler(string eventName, object eventObject) {
			string name = (string)eventObject;
			Destroy(addedPlayerObject);
			WeirdAlTestGameAudio.Instance.PlaySound3D("PlayerRemoved", gameObject.transform);
		...
		public void LeftRampHitEventHandler(string eventName, object eventData) {
			...
			WeirdAlTestGameAudio.Instance.PlaySound3D("Right_Ramp", gameObject.transform);
		}
		...
		public void NullTargetHitEventHandler(string eventName, object eventData) {
			WeirdAlTestGameAudio.Instance.PlaySound3D("ModeNullHit", gameObject.transform);
		}
		...
		public void AwardRespawnEventHandler(string evtName, object evtData) {
			...
			WeirdAlTestGameAudio.Instance.PlaySound3D("ScoopAwardRespawn", gameObject.transform);
		}
		...
		public void ShowConfirmationBoxEventHandler(string eventName, object eventData) {
			if (confirmationBox == null) {
				WeirdAlTestGameAudio.Instance.PlaySound3D("ConfirmationPopup", gameObject.transform);
			...
			Multimorphic.P3App.Logging.Logger.Log ("WeirdAlTestGame left highlight: " + data.leftHighlight.ToString());
		...
		public void DeleteProfileEventHandler(string eventName, object eventData) {
			WeirdAlTestGameAudio.Instance.PlaySound3D("ProfileDeleted", gameObject.transform);
		}

		public void CreateProfileEventHandler(string eventName, object eventData) {
			WeirdAlTestGameAudio.Instance.PlaySound3D("ProfileCreated", gameObject.transform);
		}

		public void TeamGameEnabledEventHandler(string eventName, object eventData) {
			if ((bool)eventData)
				WeirdAlTestGameAudio.Instance.PlaySound3D("TeamGameEnabled", gameObject.transform);
			else
				WeirdAlTestGameAudio.Instance.PlaySound3D("TeamGameDisabled", gameObject.transform);
		}
		...
		public void HighScoreAchievedEventHandler(string eventName, object eventData) {
			...
			{
				WeirdAlTestGameAudio.Instance.ChangePlaylistByName("HighScoreEntry");
//				highScoreBackground = (GameObject)Instantiate(Resources.Load("Prefabs/Framework/HighScore"));
		...
		public void CheaterEventHandler(string eventName, object eventData) {
            if (WeirdAlTestGameAudio.Instance)
                WeirdAlTestGameAudio.Instance.PlaySound3D("Cheater", gameObject.transform);
		}
        ...
        public void EnableBlackoutEventHandler(string eventName, object eventData)
        {
            ...
            WeirdAlTestGameAudio.Instance.PlaySound("FX/Blackout");
        }
        ...
        public void EnableReverseFlippersEventHandler(string eventName, object eventData)
        {
            ...
            WeirdAlTestGameAudio.Instance.PlaySound("FX/Reverse_flippers");
        }

        public void DisableReverseFlippersEventHandler(string eventName, object eventData)
        {
            WeirdAlTestGameAudio.Instance.PlaySound("FX/Regular_flippers");
        }
        ...
        public void EnableInvertFlippersEventHandler(string eventName, object eventData)
        {
            ...
            WeirdAlTestGameAudio.Instance.PlaySound("FX/Invert_flippers");
        }
