...
namespace PinballClub.WeirdAlTestGame.GUI {
	...
	public class WeirdAlTestGameHighScoreNameEntry : Multimorphic.P3App.GUI.TextEditor {
...
//				splash.SetActive(false);
		...
		public override void Update() {
			...
			if (textSelector != null) {
				WeirdAlTestGameTextSelector selector = textSelector as WeirdAlTestGameTextSelector;
...
//						if (splash != null)
				...
				if ((bulletModulation == 0) && (splash != null)) {
//					splash.SetActive(false);
